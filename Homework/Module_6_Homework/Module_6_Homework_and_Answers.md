...
### **Answer:**
The RMSE of this model on the validation data is 42.13.
...
### **Answer:**
The best `max_depth` is 10 with a mean RMSE of 40.117.
...
### **Answer:**
The most important feature is `study_hours_per_week` with an importance score of 0.2544.
...
### **Answer:** 
eta=0.1 gives the best RMSE on the validation dataset.
